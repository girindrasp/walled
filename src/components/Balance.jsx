...
function Balance() {
    ...
    const handleShowMoney = (showMoney) => {
    ...
    return (
        <div className='flex flex-col justify-center ml-20'>
            ...
            <div className='flex flex-row items-center'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="gray" className={showMoney ? 'hidden' : "bi bi-eye-slash"} viewBox="0 0 16 16">
